    ...
    */
    ...
    handleDeposit = event => {
        this.cuenta.deposit(
            Number(
                prompt(
                    "enter the amount to deposit on " + this.state.accountName
                )
            )
        );
    ...
    handleWithdrawl = event => {
        this.cuenta.withdrawl(
            Number(
                prompt(
                    "enter the amount to withdrawon " + this.state.accountName
                )
            )
        );
        this.setState({ accountBalance: this.cuenta.showBalance() });
    ...
    render() {
        ...
        return (
            <div className="Acc">
                ...
                <button
                    onClick={() => {
                        this.props.funcDelete(this.props.item);
                    }}
                >
                    delete
                </button>
